...
import { X, Hammer, Receipt, Activity, Loader2, Save, Landmark, Info, Wallet, Calendar, TrendingUp, Sparkles, BrainCircuit, Check, ArrowRight } from 'lucide-react';
...
export const RealEstateOperationModal: React.FC<RealEstateOperationModalProps> = ({ operation, account, onClose, targetUid }) => {
  ...
  const config = {
    ...
    OPEX: { title: 'Chi phí duy trì (OpEx)', icon: Receipt, color: 'text-rose-600', bg: 'bg-rose-50', desc: 'Phí quản lý, tiền điện nước... không làm tăng giá trị nhà.' },
