...
import { ShoppingCart, Hammer, Receipt, Activity, DollarSign, Calendar, Info } from 'lucide-react';
...
export const PropertyTimeline: React.FC<PropertyTimelineProps> = ({ logs }) => {
  ...
  const getLogConfig = (type: string) => {
    switch (type) {
      ...
      case 'OPEX': return { icon: Receipt, color: 'text-rose-600', bg: 'bg-rose-50', label: 'Chi phí duy trì' };
