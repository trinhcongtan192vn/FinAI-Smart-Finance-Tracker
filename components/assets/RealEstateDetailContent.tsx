...
import { Home, MapPin, Maximize, TrendingUp, TrendingDown, Info, ShoppingCart, DollarSign, Activity, Hammer, ReceiptText, Target, CheckCircle2, History, PiggyBank, Edit2, Check, X, Receipt, PieChart, Save, Loader2 } from 'lucide-react';
    ...
    <div className="flex flex-col animate-in fade-in duration-500 px-6 space-y-8 pb-32">
      ...
      <div className="grid grid-cols-4 gap-3">
         {[
           ...
           { id: 'OPEX', icon: ReceiptText, color: 'rose', label: 'OpEx' },
